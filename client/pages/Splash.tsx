...
export default function Splash() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 dark:from-slate-900 dark:via-blue-900 dark:to-slate-900 flex items-center justify-center relative overflow-hidden">
      {/* Top Menu Bar */}
