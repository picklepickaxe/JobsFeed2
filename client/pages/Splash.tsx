...
export default function Splash() {
  ...
  return (
    <div className={`min-h-screen w-full relative flex items-center justify-center overflow-hidden ${isLight ? 'bg-white' : 'bg-[#0a0a0a]'}`}>
      {/* Soft Dark Yellow Glow (light) or Cosmic Aurora (dark) */}
      <div
          ...
          <h1
            ...
            style={{
              backgroundImage: isLight
                ? 'linear-gradient(90deg, #a97c50 0%, #b97a56 40%, #cba07a 100%)'
